...
const (
	// name-removed: Need to adjust with the MaxExternalMessageSize parameter in SBFT
	// Calculation : defaultServerMaxReceiveMessageSize >= SBFT.MaxExternalMessageSize * BGnum
	defaultServerMaxReceiveMessageSize = 1024 * 1024 * 4 * 4

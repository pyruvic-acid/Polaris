...
constexpr uint16_t kWorkWindowSize = 5000;

constexpr uint16_t checkpointWindowSize = 2500;
...
constexpr uint32_t maxExternalMessageSize = 4 * 1024 * 1024; // TODO(GG): some message types may need different values  name-removed:: 1000

constexpr uint32_t maxReplyMessageSize = 8 * 1024 ;//name-removed affects rserved pages ClientsManager.cpp:46

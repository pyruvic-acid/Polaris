...
namespace bftEngine
{
	namespace impl
	{
		...
		static const uint32_t defaultTimeToStartSlowPathMilli = 8000; //  800; 
		static const uint32_t minTimeToStartSlowPathMilli = 1000; // 100;
		static const uint32_t maxTimeToStartSlowPathMilli = 20000;

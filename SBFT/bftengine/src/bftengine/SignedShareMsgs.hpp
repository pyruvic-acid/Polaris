...
#pragma pack(pop)
			...
			static SignedShareBase* create(int16_t type, ViewNum v, SeqNum s, ReplicaId senderId, Digest40& digest, IThresholdSigner* thresholdSigner);
		...
		public:
			static PreparePartialMsg* create(ViewNum v, SeqNum s, ReplicaId senderId, Digest40 &ppDigest, IThresholdSigner* thresholdSigner);
		...
		public:
			static CommitPartialMsg* create(ViewNum v, SeqNum s, ReplicaId senderId, Digest40 &ppDoubleDigest, IThresholdSigner* thresholdSigner);

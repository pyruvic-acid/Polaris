...
namespace bftEngine
{
	namespace impl
	{
		...
		public:
			...
			void setExpected(SeqNum seqNumber, ViewNum  view, Digest40& digest)
			{
				Assert(seqNumber != 0);
		...
		protected:
			...
			public:
				...
				SignaturesProcessingJob(
					...
					SeqNum seqNum, ViewNum  view, Digest40& digest,
				...
				virtual void execute() override
				{
...

					{
						...
						acc->setExpectedDigest(reinterpret_cast<unsigned char *>(expectedDigest.content()), sizeof(expectedDigest));
					...
					if (!succ)
					{
						...
						accWithVer->setExpectedDigest(reinterpret_cast<unsigned char *>(expectedDigest.content()), sizeof(expectedDigest));
			...
			public:
				...
				virtual void execute() override
				{
					bool succ = verifier->verify((char*)&expectedDigest, sizeof(expectedDigest), combinedSig, combinedSigLen);

...
#pragma pack(pop)
			static_assert(sizeof(Element) == (8 + sizeof(Element::prePrepreDigest) + 8 + 1), "Element (View Change) is 49B");
			...
			void addElement(const ReplicasInfo& repInfo, SeqNum  seqNum, const Digest40& prePrepreDigest, ViewNum   originView,

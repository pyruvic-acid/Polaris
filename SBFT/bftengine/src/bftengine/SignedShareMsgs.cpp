...
namespace bftEngine
{
	namespace impl
	{
		...
		SignedShareBase* SignedShareBase::create(int16_t type, ViewNum v, SeqNum s, ReplicaId senderId, Digest40& digest, IThresholdSigner* thresholdSigner)
		{
			...
			Digest40 tmpDigest;
			Digest40::calcCombination(digest, v, s, tmpDigest);

			thresholdSigner->signData((const char*)(&(tmpDigest)), sizeof(tmpDigest),
		...
		PreparePartialMsg* PreparePartialMsg::create(ViewNum v, SeqNum s, ReplicaId senderId, Digest40 &ppDigest, IThresholdSigner* thresholdSigner)
		{
		...
		CommitPartialMsg* CommitPartialMsg::create(ViewNum v, SeqNum s, ReplicaId senderId, Digest40 &ppDoubleDigest, IThresholdSigner* thresholdSigner)
		{

...
namespace bftEngine
{
	...
	namespace impl
	{
		...
		protected:
			...
			std::queue<bftEngine::duanqn::SkipCycleClientReqMsg*> requestsQueueOfPrimary; // only used by the primary
		...
		protected:
			...
			// name-removed: replace onMessage(ClientRequestMsg*) with onMessage(SkipCycleClientReqMsg*)
			void onMessage(bftEngine::duanqn::SkipCycleClientReqMsg*);

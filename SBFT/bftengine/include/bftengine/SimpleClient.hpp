...
namespace bftEngine
{
	...
	struct SimpleClientParams {
		uint64_t clientInitialRetryTimeoutMilli = 1000;
  		uint64_t clientMinRetryTimeoutMilli = 1000;
  		uint64_t clientMaxRetryTimeoutMilli = 10000;
  		uint16_t clientSendsRequestToAllReplicasFirstThresh = 8;
  		uint16_t clientSendsRequestToAllReplicasPeriodThresh = 4;
